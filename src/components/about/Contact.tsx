  ...
  return (
    <div className="mb-8 px-4 sm:px-0">
      <div className="flex items-center gap-4 mb-6">
        <MessageSquare className="w-8 h-8 text-gradient-start" />
        <h2 className="text-xl sm:text-2xl font-semibold gradient-text">Let's Vibe Together</h2>
      </div>
      ...
      <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
        <Card className="glass-card h-full hover:scale-105 transition-transform duration-300">
          <CardContent className="p-4 sm:p-6">
            <div className="flex items-center gap-4 mb-4">
              <Mail className="w-6 h-6 text-gradient-start" />
              <h3 className="text-lg sm:text-xl font-semibold gradient-text">Email</h3>
            </div>
            <button 
              onClick={() => copyToClipboard('sahilrajputsingh81@gmail.com', 'email')}
              className="text-muted-foreground hover:text-gradient-start transition-colors text-sm sm:text-base break-all"
            >
              sahilrajputsingh81@gmail.com
            </button>
          </CardContent>
        </Card>
        ...
        <Card className="glass-card h-full hover:scale-105 transition-transform duration-300">
          <CardContent className="p-4 sm:p-6">
            <div className="flex items-center gap-4 mb-4">
              <SnapchatIcon />
              <h3 className="text-lg sm:text-xl font-semibold gradient-text">Snapchat</h3>
            </div>
            <button
              onClick={() => copyToClipboard('https://www.snapchat.com/add/sahilsr81?share_id=MPeoYS2fdkA&locale=en-GB', 'snapchat')}
              className="text-muted-foreground hover:text-gradient-start transition-colors text-sm sm:text-base"
            >
              @sahilsr81
            </button>
          </CardContent>
